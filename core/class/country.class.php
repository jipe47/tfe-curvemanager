...
class Country
{
	 ...
	 */
	public static function getName($iso, $default='undefined')
	{
		$iso = strtoupper($iso);
		if($iso == "")
			return $default;
	...
	*		  is incorrect.
	*/
	public static function getFlag($iso, $getEmpty=true)
	{
		if(!self::isoExists(strtoupper($iso)))
			return $getEmpty ? PATH_TPL_COMMON."images/flag/empty.png" : "";
		else
			return PATH_TPL_COMMON."images/flag/".strtolower($iso).".png";
	}
}